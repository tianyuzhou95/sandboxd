...
func (handler *FirecrackerHandler) Checkpoint(
	ctx context.Context,
	...
	if instance.finish(Exit{ExitedAt: time.Now(), ExitCode: 0}) && instance.shouldPersist() {
...
func (handler *FirecrackerHandler) Restore(
	ctx context.Context,
